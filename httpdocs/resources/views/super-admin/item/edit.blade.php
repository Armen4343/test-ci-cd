                    ...
                    <div class="col-md-12 my-3">
                        ...
                        <div class="d-flex flex-column text-center">
                            <div class="d-flex align-items-start justify-content-center mb-7" style="color: #ff0066;">
                                ...
                                <span class="fw-bolder fs-3x" id="kt_modal_create_campaign_budget_label_1"></span>
                                <span class="fw-bolder fs-3x"></span>
                            </div>
                            <div id="kt_modal_create_campaign_budget_slider_1" class="noUi-sm" style="background: #ff0066;
"></div>
                        </div>
                        <!--end::Slider-->
                    ...
                    <div class="col-md-12 mt-3 mb-5">
                        <input type="text" class="form-control" id="price-input_1" name="price" onkeyup="calculatePrice(event)"
