...
@section('super-admin')
    <div class="card p-3">
        ...
        <div class="card-header align-items-center border-0 bg-dark">
            <!--begin::Title-->
            <h3 class="fw-bolder text-white m-0">Contact us</h3>
            <!--end::Title-->
        </div>

        <form action="{{ route('super.admin.contact.us.save') }}" method="post">
            @csrf
            @isset($contactUs->id)
            ...
            <div class="row">
                <div class="col-md-6 my-3">
                    ...
                    <input type="email" class="form-control" name="email"
                           value="{{ isset($contactUs->email) ? $contactUs->email : '' }}" required/>
                </div>
                <div class="col-md-6  my-3">
                    <label class="required fw-bold fs-6 mb-2">Phone no 1</label>
                    <input type="text" class="form-control" name="phone1"
                           value="{{ isset($contactUs->phone1) ? $contactUs->phone1 : '' }}" required/>
                </div>
                <div class="col-md-6 my-3">
                    <label class=" fw-bold fs-6 mb-2">Phone no 2</label>
                    <input type="text" class="form-control" name="phone2"
                           value="{{ isset($contactUs->phone2) ? $contactUs->phone2 : '' }}"/>
                </div>
                <div class="col-md-6 my-3">
                    <label class="required fw-bold fs-6 mb-2">Postal Code</label>
                    <input type="number" min="0" class="form-control" name="postalcode"
                           value="{{ isset($contactUs->postal_code) ? $contactUs->postal_code : '' }}" required/>
                </div>
                <div class="col-md-8 my-3">
                    <label class="required fw-bold fs-6 mb-2">Address</label>
                    <input type="text" class="form-control" name="address" required
                           value="{{ isset($contactUs->address) ? $contactUs->address : '' }}"/>
                </div>
                <div class="col-md-4 my-3">
                    <label class="required fw-bold fs-6 mb-2">Country</label>
                    <select name="country" required class="form-select" name="select2_input" data-control="select2">
                        @isset($contactUs->id)
                            <option value="{{$contactUs->country}}">{{$contactUs->country}}</option>
                        @endisset
