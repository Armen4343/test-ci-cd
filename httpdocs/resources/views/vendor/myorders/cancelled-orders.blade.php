...
<div class="card p-3">
   ...
   <div class="d-flex align-items-center position-relative my-1">
    <input type="text" data-kt-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Cerca ordine" />
   </div>
   <!--end::Search-->
			...
			<tbody>
				@foreach($orders as $order)
					<tr>
						...
						<td class="text-center">&euro;{{ number_format($order->refund_amount, 2, ',', '') }}</td>
                        <td>{{$order->status}}</td>
