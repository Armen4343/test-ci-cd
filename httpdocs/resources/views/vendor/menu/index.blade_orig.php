...
<div class="card p-3">
    <div class="card-header align-items-center">
        <h3 class="fw-bolder m-0">Menu</h3>
    </div>
    <div class="card-body">
                                        ...
                                        <form action="{{route('menu-items.store')}}" method="post" id="frm-{{$menu->id}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    <label class="required fw-bold fs-6 ">Price</label>
                                                ...
                                                <div class="col-md-6 mt-3">
                                                    <label class="required fw-bold fs-6 ">Menu Price</label>
                                                ...
                                                <div class="col-md-6 mt-3 mb-5">
                                                    <label class="required fw-bold fs-6 mb-2">Promo type</label>
                                                ...
                                                <div class="col-md-6 mt-3 mb-5">
                                                    <label class="fw-bold fs-6 mb-2">Expire date</label>
