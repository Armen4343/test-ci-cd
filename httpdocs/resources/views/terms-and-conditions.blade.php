    ...
    <div class="footer-second">
        <div class="footer-icon-div">
            <div>
             ...
             <p class="footer-text">Il nostro sito utilizza cookie, compresi cookie analitici e di profilazione, al fine di raccogliere informazioni statistiche e per garantirti un’esperienza ottimizzata. Puoi accettare tutti i cookie oppure declinare rifiutando i cookie opzionali. Per maggiori informazioni consulta la nostra Cookie Policy.</p>  
        </div>
				      ...
				      <div class="modal-body p-5 d-flex align-items-center">
		                ...
		                <div class="form-group d-flex">
		                  <input type="text" class="form-control" placeholder="Enter Email">
							...
							<button class="btn wizard-btn d-block py-3 w-100 mt-3">Submit</button>
		              </form>
