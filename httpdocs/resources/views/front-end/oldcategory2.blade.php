...
@endpush
  ...
  <div class="contaniner-fluid front-main">
	  ...
	  <div class="row p-3">
		  <div class="col-12">
		  	<h3>145 restaurants in Convent Street 2983</h3>
		  </div>
	  </div>
    <div class="row p-3 ">
      <!-- Next Column Items -->
      <div class="col-xl-10 col-lg-9 order-lg-1 order-2">
		...
		<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
			  <div class="strip">
				  <figure>
					  <span class="ribbon off">-30%</span>
					  <img src="{{asset($restaurant->profile_photo_path)}}" data-src="img/location_1.jpg" class="img-fluid lazy loaded" alt="" data-was-processed="true">
					  <a href="#" class="strip_info">
