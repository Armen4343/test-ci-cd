...
@endpush
  ...
  <div class="contaniner-fluid front-main">
	  ...
	  <div class="row p-3">
		  <div class="col-12">
		  	<h3>{{ $restaurants->count() }} restaurants founded</h3>
		  </div>
	  </div>
    <div class="row p-3 ">
      <!-- Next Column Items -->
		...
		<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
			  <div class="strip">
				  <figure>
					  ...
					  <img src="{{asset($restaurant->banner_photo_path)}}" data-src="img/location_1.jpg" class="img-fluid lazy loaded" alt="" data-was-processed="true">
					  <a href="{{ route('cat_singleitems', ['id' => encrypt($restaurant->id)]) }}" class="strip_info">
					 ...
					 @foreach($categories as $category)
					   <li class="d-flex justify-content-between">
						<div class="form-check form-check-inline">
							  <input class="form-check-input" type="checkbox" onclick="alert(this.value)" value="{{$category->id}}" id="defaultCheck1">
