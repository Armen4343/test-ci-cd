<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingUserDeletion">
            ...
            <x-slot name="content">
                {{ __('Sei sicuro di voler cancellare il tuo account? Una volta cancellato, tutti i tuoi dati saranno permanentemente cancellati. Per favore inserisci la tua password per confermare che vuoi cancellare il tuo account definitivamente.') }}
