...
A new user has just created an account / add a restaurant on our site. We wanted to let you know so that you can take a look everything looks good. Here are the details:
</div>
...
<table style="font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;">
  ...
  <tr style="background-color: #f2f2f2;text-align: left;">
    <td style="border: 1px solid #ddd;padding: 8px;">Banner photo</td>
    <td style="border: 1px solid #ddd;padding: 8px;">
		<img src="{{ asset(($details['banner_photo_path']) ? $details['banner_photo_path'] : 'images/no-image.png') }}" class="img rounded-1 shadow" style="width:100px; height:60px; object-fit:cover;box-shadow: 0 5px 15px 0 rgba(105, 103, 103, 0.5);" />
	  </td>
  </tr>
</table>
