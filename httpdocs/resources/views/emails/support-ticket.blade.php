...
A new support ticket has been created with following details:
</div>
...
<table style="font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;">
  ...
  <tr style="background-color: #f2f2f2;text-align: left;">
    <td style="border: 1px solid #ddd;padding: 8px;">Business description</td>
    <td style="border: 1px solid #ddd;padding: 8px;">{{ $details['business_description'] }}</td>
  </tr>
  <tr style="background-color: #f2f2f2;text-align: left;">
  ...
  <tr style="background-color: #f2f2f2;text-align: left;">
    <td style="border: 1px solid #ddd;padding: 8px;">Numero Ordine</td>
    <td style="border: 1px solid #ddd;padding: 8px;">{{ $details['selectedorder'] }}</td>
  </tr>
  <tr style="background-color: #f2f2f2;text-align: left;">
    <td style="border: 1px solid #ddd;padding: 8px;">Other</td>
    <td style="border: 1px solid #ddd;padding: 8px;">{{ $details['other'] }}</td>
  </tr>
  <tr style="background-color: #f2f2f2;text-align: left;">
  ...
  <tr style="background-color: #f2f2f2;text-align: left;">
    <td style="border: 1px solid #ddd;padding: 8px;">Allega File</td>
    <td style="border: 1px solid #ddd;padding: 8px;">
	  <img src="{{ asset(($details['file']) ? $details['file'] : 'images/no-image.png') }}" class="img rounded-1 shadow" style="width:120px; height:auto; object-fit:cover;box-shadow: 0 5px 15px 0 rgba(105, 103, 103, 0.5);" alt="no-image" />
	  </td>
  </tr>
